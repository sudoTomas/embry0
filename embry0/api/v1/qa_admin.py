...
``.embry0/qa.yaml`` when present. See
``embry0.workflows.qa.orchestrator._qa_orchestrator_node_impl`` for the
read-side wiring and
``embry0.storage.repositories.qa_workspace_provider_overrides`` for the
storage layer.
