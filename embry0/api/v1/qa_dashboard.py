...
from embry0.storage.repositories.qa_app_results import QAAppResultRow
from embry0.workflows.qa.subtask_result_schema import SubTaskStatus

router = APIRouter()

# Mirrors embry0/workflows/qa/subtask_result_schema.py:77 overall_status().
...
def _overall_status(rows: list[QAAppResultRow]) -> _OVERALL:
    ...
    INFRA_FAILURE short-circuits to 'infra_error' (embry0's fault, not the
