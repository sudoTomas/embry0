"""embry0 migrate-qa-config — converts qa.yaml v1 → v2 in place.

v1 reading still goes through embry0.workflows.qa.qa_yaml.parse_qa_yaml,
...
from embry0.workflows.qa.qa_yaml import parse_qa_yaml as parse_v1
...
def migrate_v1_to_v2(
    ...
    if app_name is None:
        # qa.yaml lives at <repo>/.embry0/qa.yaml — repo dir is parent.parent
