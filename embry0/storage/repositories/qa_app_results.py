...
from embry0.storage.repositories.qa_app_results_analytics import (
...
class QAAppResultRow:
    ...
    # here. Shape mirrors embry0.api.schemas.qa_dashboard.BootPhaseDetail.
...
class QAAppResultsRepository:
    ...
    async def upsert_with_boot_phase(
        ...
        *,
        ...
        ``embry0/storage/database.py``). Pre-encoding with ``json.dumps`` here
    ...
    async def list_for_job(self, job_id: str) -> list[QAAppResultRow]:
        ...
        for row in rows:
            ...
            # (see embry0/storage/database.py). No json.loads here.
