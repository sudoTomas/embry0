"""Pydantic schema for `.embry0/qa.yaml` — the per-repo QA contract.

Source of truth for "how does the QA agent boot and validate this repo".
Lives in the target repo (not in embry0) so it travels with the code.
"""
...
class QAYamlConfig(BaseModel):
    """Top-level .embry0/qa.yaml contract."""
