...
Runs after qa_orchestrator_node has aggregated per-app results. Writes:
  1. The aggregate `embry0/qa` GitHub Check Run (idempotent, by head_sha).
...
from embry0.notifications.qa_check import write_aggregate_check
from embry0.notifications.qa_comment import render_qa_comment, upsert_sticky_comment
...
async def qa_report_node(
    ...
    """Write the embry0/qa check + sticky PR comment.
