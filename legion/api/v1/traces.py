...
from legion.api.deps import get_traces_repo
...
@router.get("/traces")
async def list_traces(job_id: str | None = None, agent_type: str | None = None,
                      result: str | None = None, limit: int = 50, offset: int = 0,
                      traces: TracesRepository = Depends(get_traces_repo)) -> dict:
