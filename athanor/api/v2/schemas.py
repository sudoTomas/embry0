"""Pydantic models for the v2 dashboard API surface.
...
class RepoEntry(BaseModel):
    """One repo's row in GET /v2/repos."""
...
class RunListItem(BaseModel):
    """One row in GET /v2/repos/{repo}/runs."""
...
class RunDetail(BaseModel):
    """Full run detail returned from GET /v2/runs/{run_id}."""
...
class AppHistoryItem(BaseModel):
    """One row in GET /v2/repos/{repo}/apps/{app}/history."""
...
class LoginRequest(BaseModel):
    """POST /v2/auth/dashboard/login request body."""
...
class LoginResponse(BaseModel):
    """POST /v2/auth/dashboard/login response body."""
