...
from athanor.api.deps import get_github_sync, get_inputs_repo, get_issue_executor, get_issues_repo, get_jobs_repo
from athanor.api.schemas.inputs import AnswerInputRequest, InputResponse
from athanor.api.schemas.issues import (
    CreateIssueRequest,
    IssueDetailResponse,
    IssueListResponse,
    IssueResponse,
